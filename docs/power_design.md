...
> ⚠️ **本節已被取代（2026-08-07）**:自動充電方案已改為**接觸式刷板**,
> 權威設計見 `docs/charging_dock_design.md`(該文件 §16 列出本文件各節的有效性對照)。
> 本節保留僅供決策脈絡追溯,不得作為施工依據。
...
| 充電支路 ★二階 | U1 | 36V 無線充電模組 | 接收端 B |
| 充電支路 ★二階 | U2 | 36V 無線充電模組 | 接收端 A |
| 充電支路 ★二階 | U3 | XL4016 CC/CV | 充電降壓 A（恆流恆壓） |
| 充電支路 ★二階 | U4 | XL4016 CC/CV | 充電降壓 B |
| 充電支路 ★二階 | D1 | Ideal Diode Module | 充電支路 A 防逆流 |
| 充電支路 ★二階 | D2 | Ideal Diode Module | 充電支路 B 防逆流 |
| 充電支路 ★二階 | F5 | 5A ATO | 充電支路 A 保險絲 |
| 充電支路 ★二階 | F6 | 5A ATO | 充電支路 B 保險絲 |
...
| 型別 | 項目 | 驗不過的意思 | 處置 |
|---|---|---|---|
| **電氣風險型** | #10、#16、★二階 #11／#12／#13／#17 | 選料或設計有誤，通電會燒 | 更換元件或補上保護後**重驗**，未過不得通電 |
...
| 9 | **★二階 RX⊖ 浮接**（§15.3） | RX 兩線**尚未接上 buck 時**，以電阻檔量 RX⊖ ↔ 車體金屬、RX⊖ ↔ －端子台 | 兩項皆為**開路** | 任一項不是開路表示已存在非預期路徑，**排除後才可上電**（§15.3） |
